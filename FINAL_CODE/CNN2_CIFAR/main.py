...
def main():
    ...
    #choose 1. data augmentation or not
    if args.augment==False:
        dataset1 = datasets.CIFAR10('../data', train=True, download=True,transform=transform)
    else:
        dataset1 = datasets.CIFAR10('../data', train=True, download=True,transform=transform_rotran)
    ...
    if args.train==True:
        ...
        if args.augment==True:
            model.load_state_dict(torch.load('./parameter/CNN2_CIFAR_AUG.pt'))
        if args.augment==False:
            model.load_state_dict(torch.load('./parameter/CNN2_CIFAR.pt'))
